...
function tag () {
  ...
  execSync(`git push git@github.com:Xzillion/ant-design-vue.git ${version}:${version}`)
  execSync(`git push git@github.com:Xzillion/ant-design-vue.git master:master`)
  console.log('tagged')
}
